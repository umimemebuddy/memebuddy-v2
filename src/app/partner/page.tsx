      ...
      <section className="py-6">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 mb-4">
            <a href="https://t.me/Yyuzuz" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-3 transition-all hover:scale-110 font-bold text-base"
              style={{ border: "2px solid #229ED9", background: "rgba(34,158,217,0.1)", borderRadius: "10px", boxShadow: "0 0 20px rgba(34,158,217,0.2)", color: "#229ED9" }}>
              <span className="text-2xl">✈️</span> TELEGRAM @Yyuzuz
            </a>
            <a href="https://github.com/umimemebuddy/DRINK_MASTER" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-3 transition-all hover:scale-110 font-bold text-base"
              style={{ border: "2px solid #06b6d4", background: "rgba(6,182,212,0.1)", borderRadius: "10px", boxShadow: "0 0 20px rgba(6,182,212,0.2)", color: "#06b6d4" }}>
            ...
            <a href="https://instagram.com/umi_jewelry_gemstone" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-3 transition-all hover:scale-110 font-bold text-base"
              style={{ border: "2px solid #e1306c", background: "rgba(225,48,108,0.1)", borderRadius: "10px", boxShadow: "0 0 20px rgba(225,48,108,0.2)" }}>
              <span className="text-2xl">📸</span> <span className="ig-gemstone">INSTAGRAM</span>
            </a>
            <a href="https://x.com/DommeByte" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-3 transition-all hover:scale-110 font-bold text-base"
              style={{ border: "2px solid #e11d48", background: "rgba(225,29,72,0.1)", borderRadius: "10px", boxShadow: "0 0 20px rgba(225,29,72,0.2)", color: "#e11d48" }}>
